 ...
 * @author lsoares
 */
public class NewVirtualHost extends javax.swing.JFrame {

    /**
     * Creates new form NewVirtualHost
     */
    public NewVirtualHost() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewVirtualHost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewVirtualHost().setVisible(true);
            }
        });
    }
